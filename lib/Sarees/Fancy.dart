...
class Fancy extends StatefulWidget {
  @override
  State<Fancy> createState() => _PattuSareeState();
}

class _PattuSareeState extends State<Fancy> {
  final CollectionReference fetchData = FirebaseFirestore.instance.collection('Fancy');
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => SareeCartPage(isLoggedIn: userPhoneNumber != null)));
          },
        ...
        SnackBar(
          ...
          action: SnackBarAction(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => SareeCartPage(isLoggedIn: widget.userPhoneNumber != null))
              );
            },
          ),
        ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isAddedToCart ? Colors.red.shade400 : Colors.green.shade700,
